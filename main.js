...
let randomPhrase = cookiePhrases[Math.round(Math.random() * cookiePhrases.length)]
const tryAgain = document.querySelector(".tryAgain")
const btnOpeningCookie = document.querySelector(".btnOpeningCookie")
...
function breakCookie(){
  ...
  document.querySelector(".phrase").innerText = `${randomPhrase}`
}
...
btnOpeningCookie.addEventListener('click', breakCookie)
tryAgain.addEventListener('click', openAgain)
